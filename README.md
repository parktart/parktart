...
I recently completed [The Odin Project](https://www.theodinproject.com/) Foundations, a 50-module open-source web development curriculum that teaches the fundamentals of building responsive websites using HTML, CSS, and JavaScript. I’m now looking to contribute as a **Web Developer** on a team where I am challenged to constantly learn, grow, and refine my skills.
...
Cooking! Check out my [recipe-blog-site repo](https://github.com/parktart/recipe-blog-site) for a mock food blog featuring all my own photos! Here is the [live page](https://parktart.github.io/recipe-blog-site/). Also ask me anything about cooking!
